...
var CarouselItem = React6.memo(function(props) {
  var mergeProps = useMergeProps();
  ...
  return React6.createElement("div", itemClonedProps, content);
});
var Carousel = React6.memo(React6.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React6.useContext(PrimeReactContext);
  var props = CarouselBase.getProps(inProps, context);
  var _React$useState = React6.useState(props.numVisible), _React$useState2 = _slicedToArray2(_React$useState, 2), numVisibleState = _React$useState2[0], setNumVisibleState = _React$useState2[1];
  var _React$useState3 = React6.useState(props.numScroll), _React$useState4 = _slicedToArray2(_React$useState3, 2), numScrollState = _React$useState4[0], setNumScrollState = _React$useState4[1];
  var _React$useState5 = React6.useState(props.page * props.numScroll * -1), _React$useState6 = _slicedToArray2(_React$useState5, 2), totalShiftedItemsState = _React$useState6[0], setTotalShiftedItemsState = _React$useState6[1];
  var _React$useState7 = React6.useState(props.page), _React$useState8 = _slicedToArray2(_React$useState7, 2), pageState = _React$useState8[0], setPageState = _React$useState8[1];
  ...
  var itemsContainerRef = React6.useRef(null);
  var remainingItems = React6.useRef(0);
  var allowAutoplay = React6.useRef(!!props.autoplayInterval);
  var attributeSelector = React6.useRef("");
  var swipeThreshold = React6.useRef(20);
  var startPos = React6.useRef(null);
  var interval = React6.useRef(null);
  var carouselStyle = React6.useRef(null);
  var indicatorContent = React6.useRef(null);
  var isRemainingItemsAdded = React6.useRef(false);
  var responsiveOptions = React6.useRef(null);
    ...
    if (props.value && props.value.length) {
      ...
      if (isCircular) {
        ...
        clonedItemsForStarting = clonedElements.map(function(item2, index) {
          ...
          return React6.createElement(CarouselItem, {
            key,
      ...
      return React6.createElement(React6.Fragment, null, clonedItemsForStarting, items, clonedItemsForFinishing);
    }
  };
  var createHeader = function createHeader2() {
    if (props.header) {
      ...
      return React6.createElement("div", headerProps, props.header);
    }
    return null;
  };
  var createFooter = function createFooter2() {
    if (props.footer) {
      ...
      return React6.createElement("div", footerProps, props.footer);
    }
    return null;
  };
  var createContent = function createContent2() {
    ...
    return React6.createElement("div", containerProps, backwardNavigator, React6.createElement("div", itemsContentProps, React6.createElement("div", _extends6({
  ...
  var createBackwardNavigator = function createBackwardNavigator2() {
    if (props.showNavigators) {
      ...
      var icon = isVertical ? props.prevIcon || React6.createElement(ChevronUpIcon, previousButtonIconProps) : props.prevIcon || React6.createElement(ChevronLeftIcon, previousButtonIconProps);
      var backwardNavigatorIcon = IconUtils.getJSXIcon(icon, _objectSpread2({}, previousButtonIconProps), {
        props
      });
      ...
      return React6.createElement("button", previousButtonProps, backwardNavigatorIcon, React6.createElement(Ripple, null));
    }
    return null;
  };
  var createForwardNavigator = function createForwardNavigator2() {
    if (props.showNavigators) {
      ...
      var icon = isVertical ? props.nextIcon || React6.createElement(ChevronDownIcon, nextButtonIconProps) : props.nextIcon || React6.createElement(ChevronRightIcon, nextButtonIconProps);
      var forwardNavigatorIcon = IconUtils.getJSXIcon(icon, _objectSpread2({}, nextButtonIconProps), {
        props
      });
      ...
      return React6.createElement("button", nextButtonProps, forwardNavigatorIcon, React6.createElement(Ripple, null));
    }
    return null;
  };
  ...
  var createIndicator = function createIndicator2(index) {
    ...
    return React6.createElement("li", _extends6({}, indicatorProps, {
      key
    }), React6.createElement("button", indicatorButtonProps, React6.createElement(Ripple, null)));
  };
  var createIndicators = function createIndicators2() {
    if (props.showIndicators) {
      ...
      return React6.createElement("ul", indicatorsProps, _indicators);
    }
    return null;
  };
  ...
  return React6.createElement("div", rootProps, header, React6.createElement("div", contentProps, content, indicators), footer);
}));
